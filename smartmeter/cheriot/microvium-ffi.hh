...
// XXX rtos#437
	...
	/** Read data about any grid planned outage */
	int32_t read_from_snapshot(int32_t ix)
	{
		...
		switch (ix)
		{
			...
			case DATA_SENSOR_SAMPLE_0 ... DATA_SENSOR_SAMPLE_7:
				return snapshots->sensor_data
				  .samples[ix - DATA_SENSOR_SAMPLE_0];
